...
class XirrCalculationTest extends TestCase
{
     ...
     */
    public function testBasicXirrCalculation(): void
    {
     ...
     */
    public function testXirrMultipleCashFlows(): void
    {
        // Investment of $10,000 on Jan 1, 2020
     ...
     */
    public function testXirrWithDateTimeObjects(): void
    {
        $cashFlows = [-10000, 11000];
        $dates = [
     ...
     */
    public function testXirrWithMixedDateFormats(): void
    {
        $cashFlows = [-5000, 6000];
        $dates = [
            '2020-06-15',
     ...
     */
    public function testXirrNegativeReturn(): void
    {
        // Investment of $10,000 on Jan 1, 2020
     ...
     */
    public function testXirrSameDatesSumZero(): void
    {
     ...
     */
    public function testXirrSameDatesNotSumZero(): void
    {
     ...
     */
    public function testXirrErrorInsufficientData(): void
    {
     ...
     */
    public function testXirrErrorMismatchedArrays(): void
    {
     ...
     */
    public function testXirrErrorAllPositive(): void
    {
     ...
     */
    public function testXirrErrorAllNegative(): void
    {
     ...
     */
    public function testXirrVeryCloseDates(): void
    {
     ...
     */
    public function testXirrHighReturn(): void
    {
     ...
     */
    public function testXirrLongPeriod(): void
    {
     ...
     */
    public function testXirrLeapYear(): void
    {
        $cashFlows = [-10000, 11000];
     ...
     */
    public function testXirrDifferentGuess(): void
    {
     ...
     */
    public function testXirrManyCashFlows(): void
    {
     ...
     */
    public function testXirrSumZeroDifferentDates(): void
    {
        $cashFlows = [-10000, 10000]; // Sum is zero
     ...
     */
    public function testXirrSmallAmounts(): void
    {
     ...
     */
    public function testXirrLargeAmounts(): void
    {
     ...
     */
    public function testXirrNearMinus100Percent(): void
    {
     ...
     */
    public function testXirrVeryHighPositiveRate(): void
    {
     ...
     */
    public function testXirrAlternatingSigns(): void
    {
     ...
     */
    public function testXirrMostlyZeros(): void
    {
     ...
     */
    public function testXirrAllZeros(): void
    {
    ...
    public function testXirrWithKnownScenarios(array $cashFlows, array $dates, float $expected, float $tolerance): void
    {
        $xirr = Helper::calculateXIRR($cashFlows, $dates);
