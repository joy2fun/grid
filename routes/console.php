...
Schedule::command('app:sync-realtime-prices etf')
    ->everyMinute()
    ->weekdays()
    ->between('9:30', '11:31')
...
Schedule::command('app:sync-realtime-prices index')
    ->weekdays()
...
Schedule::command('app:sync-realtime-prices index')->weekdays()->at('17:01');
